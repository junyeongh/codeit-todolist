...
function TaskItemInputImage() {
  const hasImage = true;

  return (
    <div className="relative lg:px-40 px-[140px] py-31 bg-slate-50 border-2 border-dashed border-slate-300 rounded-3xl">
...
function TaskItemInputText() {
  return (
    <div style={{ backgroundImage: "url('/note.png')" }} className="flex-1 rounded-3xl ">
      <div className="pt-6 flex justify-center">Memo</div>
      <textarea className="items-center justify-center border-solid border-2 border-slate-900 w-full resize-none p-4"></textarea>
    </div>
  )
}
